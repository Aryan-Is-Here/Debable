...
Runs migrations through the same async engine configuration the application uses, and
takes the URL from ``app.core.config`` so there is exactly one source for it.
"""
